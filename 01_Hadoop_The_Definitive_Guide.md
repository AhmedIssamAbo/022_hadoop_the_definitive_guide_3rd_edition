...
0x02.使用MapReduce运行分布式计算
0x03.使用Hadoop的数据和I/O构建块进行压缩、数据完整性、序列化（包括Avro）和吃持久化
0x04.探究MapReduce应用开发中常见的陷阱和高级特性
0x05.设计、构建和管理Hadoop专用集群或在云上运行Hadoop
0x06.使用Sqoop把数据从关系型数据库载入HDFS
0x07.使用Pig查询语言执行大规模数据处理
0x08.使用Hive（Hadoop的数据仓库系统）来分析数据集
